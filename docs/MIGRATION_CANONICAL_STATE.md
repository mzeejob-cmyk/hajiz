...
| `20260829183000_flight_payment_initiation_v1.sql` | CODE-ONLY; NOT YET APPLIED | Adds the B12 payment-initiation claim and atomic booking/payment materialization. The Gate A-compatible definition uses non-forced RLS and shared table/function ownership without a `BYPASSRLS` dependency. Requires a separate runtime gate after B11 |
