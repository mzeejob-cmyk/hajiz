...
await test("Customer Packages unchanged", () => execFileSync("git", ["diff", "--quiet", "ee468d55bdead5f950ed720c1a58d79cf08aef7a", "--", "src/features/packages/PackagesPage.jsx"]))
await test("Customer Offers unchanged", () => execFileSync("git", ["diff", "--quiet", "ee468d55bdead5f950ed720c1a58d79cf08aef7a", "--", "src/features/offers/OffersPage.jsx"]))
