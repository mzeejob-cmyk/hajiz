...
export function createMultiSupplierSearchPolicy(input = {}) {
  ...
  const unknown = Object.keys(input).filter((key) => !["maxConcurrency", "supplierTimeoutMs", "requestTimeoutMs"].includes(key))
  ...
  return Object.freeze({
    ...
    requestTimeoutMs: boundedInteger(input.requestTimeoutMs, "requestTimeoutMs", 1, 120_000, DEFAULT_MULTI_SUPPLIER_SEARCH_POLICY.requestTimeoutMs),
  })
}
